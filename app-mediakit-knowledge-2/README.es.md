# app-mediakit-knowledge-2

Reescritura desde cero del motor wiki de conocimiento de PointSav. Nombre temporal
`-2`; se renombrará a `app-mediakit-knowledge` en la sustitución final.
...
```
cargo build -p app-mediakit-knowledge-2
```

## Ejecución

```
app-mediakit-knowledge-2 serve --knowledge-toml /etc/local-knowledge/documentation.toml
```
