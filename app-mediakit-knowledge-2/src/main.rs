//! app-mediakit-knowledge-2 binary — CLI entry point.
//!
//! Subcommands:
...
use app_mediakit_knowledge_2::app::{router, AppState};
use app_mediakit_knowledge_2::config::Config;

#[derive(Parser)]
#[command(name = "app-mediakit-knowledge-2", version, about = "Knowledge wiki engine (rewrite)")]
struct Cli {
    #[command(subcommand)]
    command: Command,
}
