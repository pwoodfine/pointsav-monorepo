...
draft-id: gis-20260629-journal-regional-markets-top600
title: "Top 600 Regional Markets: A Country-Normalized Co-location Scoring System for Multi-Country Retail Site Selection"
status: staged
owner: project-gis
route-to: totebox@project-editorial
target-journal: "Journal of Retailing and Consumer Services"
created: 2026-06-29
updated: 2026-06-29
research-trail:
  data-source: "OpenStreetMap via Overpass API; Wikidata chain identifiers; StatCan CMA/CSD boundaries; US CBSA polygons"
  methods: "DBSCAN spatial clustering (haversine distance matrix); per-country min-max normalization; T1/T2/T3 tier taxonomy from Woodfine et al. J1"
  research-date: 2026-06-29
  ai-tool: "claude-sonnet-4-6 (Anthropic) — draft structuring, scoring algorithm documentation"
  review-status: stub — all body sections except §4/§5 require expansion to 8,000-word target
---
...
5. Jerez de la Frontera (ES) — nr. Cádé 76 km — index 100
